...
int main()
{
  ...
  for (int period = 12; period <= 240; period += 12) {
    ...
    int res1 = autocorrelate_detect_period(signed_12bps_test, BUF_SIZE,
kAC_12bps_signed);
    int res2 = autocorrelate_detect_period(unsigned_12bps_test, BUF_SIZE,
kAC_12bps_unsigned);
    int res3 = autocorrelate_detect_period(signed_16bps_test, BUF_SIZE,
kAC_16bps_signed);
    int res4 = autocorrelate_detect_period(unsigned_16bps_test, BUF_SIZE,
kAC_16bps_unsigned);
